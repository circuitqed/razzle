...
export default function GoogleSignInButton({ onError }: GoogleSignInButtonProps) {
  const handleClick = () => {
    ...
    // Build the Google OAuth URL for the authorization code flow
    ...
    // Redirect the whole page to Google (no popup)
  ...
  return (
    <button
      type="button"
      onClick={handleClick}
      className="w-full flex items-center justify-center gap-3 px-4 py-2.5 bg-white hover:bg-gray-100 text-gray-800 rounded font-medium transition-colors border border-gray-300"
    >
